...
const char *htmlTemplate = R"rawliteral(
      ...
      <head>
        ...
        <style>
            ...
            h2 {
                ...
                font-size: 32px;
                border-bottom: 2px solid #555555; /* Un borde gris medio */
                padding-bottom: 5px;
                margin-bottom: 20px;
            }

            h3 {
                color: #bbbbbb; /* Gris medio-claro */
                font-size: 20px;
                margin-top: 30px;
                padding-bottom: 5px;
                border-bottom: 1px solid #444444; /* Un borde gris oscuro */
            }

            h4 {
                color: #dddddd; /* Blanco roto o gris muy claro */
                font-size: 18px;
                margin-top: 20px;
            }
            ...
            .section {
                ...
                border-radius: 10px;
                margin-bottom: 20px;
                border: 1px solid #333; /* Bordes más visibles */
            }
      ...
      <body>
        ...
        <div class="section">
            ...
            <h3>Motor Cámara</h3>
            <h4>Speed</h4>
            <p><span id='speedValueDisplay'>24</span> fps</p>
            <input type='range' min='0' max='50' value='24' id='speedSlider'>
            <input type='checkbox' id='speedCheckbox'> Activar Speed

            <h4>Intervalómetro:</h4>
            <label for='intervalFrames'>Frames:</label>
            <input type='number' id='intervalFrames' value='1' min='1'>
            ...
            <br><br>
            <button onclick="sendMotorCameraData()">Enviar Motor Cámara</button>
        ...
        <div class="section">
            ...
            <br><br>
            <button onclick="sendShutterData()">Enviar Shutter</button>
        ...
        <div class="section">
            ...
            <iframe src="http://192.168.8.5" width="100%" height="400px" style="border: none;"></iframe>
        </div>
        ...
        <div class="section">
            ...
            <br><br>
            <button onclick="sendOpticsData()">Enviar Óptica</button>
        ...
        <div class="section">
            ...
            <br>
            <button onclick="moveMotor('x0')">Mover X0</button>
            ...
            <br>
            <button onclick="moveMotor('x1')">Mover X1</button>
            ...
            <br>
            <button onclick="moveMotor('y0')">Mover Y0</button>
